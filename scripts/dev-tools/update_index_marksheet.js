...
const filePath = 'c:\\\\Users\\\\diwas\\\\OneDrive\\\\Documents\\\\Desktop\\\\school management saraswati\\\\index.html';
...
const htmlPattern = /<!-- Results Display Area -->[\s\S]*?<\/div>\s*<\/div>\s*<\/div>/;
...
// Find checkStudentResult function and replace it
const jsPattern = /function checkStudentResult\(\) \{[\s\S]*?(?=\n  \}\n)\n  \}/;
content = content.replace(jsPattern, jsFunc);

fs.writeFileSync(filePath, content, 'utf-8');
console.log("Updated index.html with printable marksheet format using Node.");
