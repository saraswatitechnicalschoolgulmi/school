...
// The new logic for renderResultsWithGPA to add GPA and Grade, and dynamic year
...
const newLogic = `let theadHtml = \`
      ...
      theadHtml += '<th rowspan="3">Overall GPA</th><th rowspan="3">Grade</th><th rowspan="3">Action</th></tr><tr>';
...
if (oldRegex.test(content)) {
    ...
    console.log("Successfully added GPA and Grade to ledger.");
} else {
